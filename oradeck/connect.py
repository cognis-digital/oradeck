"""Native cognis-connect emit for oradeck — forward findings to any platform.

Maps oradeck's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    oradeck ... --format json | oradeck-emit --to stix
    oradeck-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
